...
import type { StatsQuestion } from './logic';
...
export function answerKeyText(q: StatsQuestion, num: number): string {
...
export function generateStatsPdf(opts: StatsPdfOptions): jsPDF {
